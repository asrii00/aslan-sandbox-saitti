...
marryCheckBox.addEventListener('change', (event) => { //if you go back, this doesn't get triggered
...
incomeBox.addEventListener('blur', incomeChecker); //bugs out sometimes? at least with autofill
